...
for i in range(len(threads)):
    ...
    if threads[i] == 11:
        ...
        df_apple_xl.loc[threads_omp.index(threads[i]), 'avg'] = np.average(tt_apple_xl_old[10*i:10*(i+1)])
...
for f in figures:
    ...
    match f:
        case "simd":
            plt.savefig("../Graphs/4. Presentation/SIMD.png", dpi=300)
        case "simd_xl":
            plt.savefig("../Graphs/4. Presentation/SIMD XL.png", dpi=300)
        case "omp":
            plt.savefig("../Graphs/4. Presentation/OpenMP.png", dpi=300)
        case "omp_xl":
            plt.savefig("../Graphs/4. Presentation/OpenMP XL.png", dpi=300)
        case "simd_intel":
            plt.savefig("../Graphs/4. Presentation/ICPX SIMD.png", dpi=300)
        case "simd_xl_intel":
            plt.savefig("../Graphs/4. Presentation/ICPX SIMD XL.png", dpi=300)
        case "omp_intel":
            plt.savefig("../Graphs/4. Presentation/ICPX OpenMP.png", dpi=300)
        case "omp_xl_intel":
            plt.savefig("../Graphs/4. Presentation/ICPX OpenMP XL.png", dpi=300)
        case "cuda":
            plt.savefig("../Graphs/4. Presentation/CUDA.png", dpi=300)
        case "cuda_xl":
            plt.savefig("../Graphs/4. Presentation/CUDA XL.png", dpi=300)
        case "cpu_gpu":
            plt.savefig("../Graphs/4. Presentation/CPU vs GPU.png", dpi=300)
        case "cpu_gpu_xl":
            plt.savefig("../Graphs/4. Presentation/CPU vs GPU XL.png", dpi=300)
