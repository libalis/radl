    ...
    __attribute__((always_inline)) inline void add_simd(mt_arg *mt) {
                    ...
                    for(int j = 0; j < (*mt->c)->y; j += CHUNK_SIZE) {
                        m = (__mmask64)((1 << (((j + CHUNK_SIZE) <= (*mt->c)->y) ? CHUNK_SIZE : (*mt->c)->y - j)) - 1);
                        a = _mm512_maskz_loadu_epi8(m, &(*mt->a)->m[get_idx(mt->i, j, (*mt->a)->y)]);
                        b = _mm512_maskz_loadu_epi8(m, &(*mt->b)->m[get_idx(mt->i, j, (*mt->b)->y)]);
                        _mm512_mask_storeu_epi8(&(*mt->c)->m[get_idx(mt->i, j, (*mt->c)->y)], m, _mm512_add_epi8(a, b));
                    }
                #else
                    ...
                    for(int j = 0; j + CHUNK_SIZE - 1 < (*mt->c)->y; j += CHUNK_SIZE) {
                        ...
                        _mm256_storeu_si256((__m256i*)&(*mt->c)->m[get_idx(mt->i, j, (*mt->c)->y)], _mm256_add_epi8(a, b));
                    }
        ...
        #else
            #ifdef INT
                long CHUNK_SIZE = sizeof(int8x16_t) / sizeof(DATA_TYPE);
                int8x16_t a, b;
                for (int j = 0; j + CHUNK_SIZE - 1 < (*mt->c)->y; j += CHUNK_SIZE) {
                    a = vld1q_s8(&(*mt->a)->m[get_idx(mt->i, j, (*mt->a)->y)]);
                    b = vld1q_s8(&(*mt->b)->m[get_idx(mt->i, j, (*mt->b)->y)]);
                    vst1q_s8(&(*mt->c)->m[get_idx(mt->i, j, (*mt->c)->y)], vaddq_s8(a, b));
                }
                for(int j = (*mt->c)->y - ((*mt->c)->y % CHUNK_SIZE); j < (*mt->c)->y; j++) {
                    (*mt->c)->m[get_idx(mt->i, j, (*mt->c)->y)] = (*mt->a)->m[get_idx(mt->i, j, (*mt->a)->y)] + (*mt->b)->m[get_idx(mt->i, j, (*mt->b)->y)];
                }
    ...
    __attribute__((always_inline)) inline void biasing_simd(mt_arg *mt) {
                    ...
                    for(int j = 0; j < mt->a[mt->m]->y; j += CHUNK_SIZE) {
                        m = (__mmask64)((1 << (((j + CHUNK_SIZE) <= mt->a[mt->m]->y) ? CHUNK_SIZE : mt->a[mt->m]->y - j)) - 1);
                        a = _mm512_maskz_loadu_epi8(m, &mt->a[mt->m]->m[get_idx(mt->i, j, mt->a[mt->m]->y)]);
                        b = _mm512_set1_epi8((*mt->b)->m[get_idx(mt->m, 0, (*mt->b)->y)]);
                        _mm512_mask_storeu_epi8(&mt->c[mt->m]->m[get_idx(mt->i, j, mt->c[mt->m]->y)], m, _mm512_add_epi8(a, b));
                    }
                #else
                    long CHUNK_SIZE = sizeof(__m512) / sizeof(DATA_TYPE);
                    __m512 a, b;
                    ...
                    for(int j = 0; j + CHUNK_SIZE - 1 < mt->a[mt->m]->y; j += CHUNK_SIZE) {
                        ...
                        b = _mm256_set1_epi8((*mt->b)->m[get_idx(mt->m, 0, (*mt->b)->y)]);
                        _mm256_storeu_si256((__m256i*)&mt->c[mt->m]->m[get_idx(mt->i, j, mt->c[mt->m]->y)], _mm256_add_epi8(a, b));
                    }
                ...
                int8x16_t a, b;
                for(int j = 0; j + CHUNK_SIZE - 1 < mt->a[mt->m]->y; j += CHUNK_SIZE) {
                    a = vld1q_s8(&mt->a[mt->m]->m[get_idx(mt->i, j, mt->a[mt->m]->y)]);
                    b = vdupq_n_s8((*mt->b)->m[get_idx(mt->m, 0, (*mt->b)->y)]);
                    vst1q_s8(&mt->c[mt->m]->m[get_idx(mt->i, j, mt->c[mt->m]->y)], vaddq_s8(a, b));
                }
                for(int j = mt->a[mt->m]->y - (mt->a[mt->m]->y % CHUNK_SIZE); j < mt->a[mt->m]->y; j++) {
                    mt->c[mt->m]->m[get_idx(mt->i, j, mt->c[mt->m]->y)] = mt->a[mt->m]->m[get_idx(mt->i, j, mt->a[mt->m]->y)] + (*mt->b)->m[get_idx(mt->m, 0, (*mt->b)->y)];
                }
    ...
    __attribute__((always_inline)) inline void conv2d_simd(mt_arg *mt) {
                    ...
                    for(int k = 0; k < mt->b[mt->m]->x; k++) {
                        for(int l = 0; l < mt->b[mt->m]->y; l += CHUNK_SIZE) {
                            m = (__mmask32)((1 << (((l + CHUNK_SIZE) <= mt->b[mt->m]->y) ? CHUNK_SIZE : mt->b[mt->m]->y - l)) - 1);
                            a = _mm256_maskz_loadu_epi8(m, &(*mt->a)->m[get_idx(mt->i + k, mt->j + l, (*mt->a)->y)]);
                            b = _mm256_maskz_loadu_epi8(m, &mt->b[mt->m]->m[get_idx(k, l, mt->b[mt->m]->y)]);
                            sum += _mm256_reduce_add_epi16(_mm256_mullo_epi16(_mm256_cvtepi8_epi16(_mm256_extractf128_si256(a, 0)), _mm256_cvtepi8_epi16(_mm256_extractf128_si256(b, 0))));
                            sum += _mm256_reduce_add_epi16(_mm256_mullo_epi16(_mm256_cvtepi8_epi16(_mm256_extractf128_si256(a, 1)), _mm256_cvtepi8_epi16(_mm256_extractf128_si256(b, 1))));
                        }
                    }
                    ...
                    for(int k = 0; k < mt->b[mt->m]->x; k++) {
                        for(int l = 0; l + CHUNK_SIZE - 1 < mt->b[mt->m]->y; l += CHUNK_SIZE) {
                            ...
                            result = _mm256_mullo_epi16(_mm256_cvtepi8_epi16(_mm256_extractf128_si256(a, 0)), _mm256_cvtepi8_epi16(_mm256_extractf128_si256(b, 0)));
                            sum += _mm_extract_epi16(_mm_hadd_epi16(_mm_hadd_epi16(_mm_add_epi16(_mm256_castsi256_si128(result), _mm256_extractf128_si256(result, 1)), _mm_setzero_si128()), _mm_setzero_si128()), 0);
                            result = _mm256_mullo_epi16(_mm256_cvtepi8_epi16(_mm256_extractf128_si256(a, 1)), _mm256_cvtepi8_epi16(_mm256_extractf128_si256(b, 1)));
                            sum += _mm_extract_epi16(_mm_hadd_epi16(_mm_hadd_epi16(_mm_add_epi16(_mm256_castsi256_si128(result), _mm256_extractf128_si256(result, 1)), _mm_setzero_si128()), _mm_setzero_si128()), 0);
                        }
                ...
                for(int k = 0; k < mt->b[mt->m]->x; k++) {
                    for(int l = 0; l + CHUNK_SIZE - 1 < mt->b[mt->m]->y; l += CHUNK_SIZE) {
                        a = vld1q_s8(&(*mt->a)->m[get_idx(mt->i + k, mt->j + l, (*mt->a)->y)]);
                        b = vld1q_s8(&mt->b[mt->m]->m[get_idx(k, l, mt->b[mt->m]->y)]);
                        sum += vaddvq_s8(vmulq_s8(a, b));
                    }
                    for(int l = mt->b[mt->m]->y - (mt->b[mt->m]->y % CHUNK_SIZE); l < mt->b[mt->m]->y; l++) {
                        sum += (*mt->a)->m[get_idx(mt->i + k, mt->j + l, (*mt->a)->y)] * mt->b[mt->m]->m[get_idx(k, l, mt->b[mt->m]->y)];
                    }
    ...
    __attribute__((always_inline)) inline void matmul_simd(mt_arg *mt) {
                    ...
                    for(int k = 0; k < (*mt->a)->y; k += CHUNK_SIZE) {
                        m = (__mmask32)((1 << (((k + CHUNK_SIZE) <= (*mt->a)->y) ? CHUNK_SIZE : (*mt->a)->y - k)) - 1);
                        a = _mm256_maskz_loadu_epi8(m, &(*mt->a)->m[get_idx(mt->i, k, (*mt->a)->y)]);
                        b = _mm256_maskz_loadu_epi8(m, &(*mt->b)->m[get_idx(mt->j, k, (*mt->b)->y)]);
                        (*mt->c)->m[get_idx(mt->i, mt->j, (*mt->c)->y)] += _mm256_reduce_add_epi16(_mm256_mullo_epi16(_mm256_cvtepi8_epi16(_mm256_extractf128_si256(a, 0)), _mm256_cvtepi8_epi16(_mm256_extractf128_si256(b, 0))));
                        (*mt->c)->m[get_idx(mt->i, mt->j, (*mt->c)->y)] += _mm256_reduce_add_epi16(_mm256_mullo_epi16(_mm256_cvtepi8_epi16(_mm256_extractf128_si256(a, 1)), _mm256_cvtepi8_epi16(_mm256_extractf128_si256(b, 1))));
                    }
                #else
                    long CHUNK_SIZE = sizeof(__m512) / sizeof(DATA_TYPE);
                    __m512 a, b;
                    ...
                    for(int k = 0; k + CHUNK_SIZE - 1 < (*mt->a)->y; k += CHUNK_SIZE) {
                        ...
                        result = _mm256_mullo_epi16(_mm256_cvtepi8_epi16(_mm256_extractf128_si256(a, 0)), _mm256_cvtepi8_epi16(_mm256_extractf128_si256(b, 0)));
                        (*mt->c)->m[get_idx(mt->i, mt->j, (*mt->c)->y)] += _mm_extract_epi16(_mm_hadd_epi16(_mm_hadd_epi16(_mm_add_epi16(_mm256_castsi256_si128(result), _mm256_extractf128_si256(result, 1)), _mm_setzero_si128()), _mm_setzero_si128()), 0);
                        result = _mm256_mullo_epi16(_mm256_cvtepi8_epi16(_mm256_extractf128_si256(a, 1)), _mm256_cvtepi8_epi16(_mm256_extractf128_si256(b, 1)));
                        (*mt->c)->m[get_idx(mt->i, mt->j, (*mt->c)->y)] += _mm_extract_epi16(_mm_hadd_epi16(_mm_hadd_epi16(_mm_add_epi16(_mm256_castsi256_si128(result), _mm256_extractf128_si256(result, 1)), _mm_setzero_si128()), _mm_setzero_si128()), 0);
                    }
                ...
                int8x16_t a, b;
                for(int k = 0; k + CHUNK_SIZE - 1 < (*mt->a)->y; k += CHUNK_SIZE) {
                    a = vld1q_s8(&(*mt->a)->m[get_idx(mt->i, k, (*mt->a)->y)]);
                    b = vld1q_s8(&(*mt->b)->m[get_idx(mt->j, k, (*mt->b)->y)]);
                    (*mt->c)->m[get_idx(mt->i, mt->j, (*mt->c)->y)] += vaddvq_s8(vmulq_s8(a, b));
                }
                for(int k = (*mt->a)->y - ((*mt->a)->y % CHUNK_SIZE); k < (*mt->a)->y; k++) {
                    (*mt->c)->m[get_idx(mt->i, mt->j, (*mt->c)->y)] += (*mt->a)->m[get_idx(mt->i, k, (*mt->a)->y)] * (*mt->b)->m[get_idx(mt->j, k, (*mt->b)->y)];
                }
